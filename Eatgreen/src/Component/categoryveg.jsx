...
const CategoryVeg = () => {
    ...
    const [trendingDeals, setTrendingDeals] = useState([
        { id: 7, image:{uri: 'https://i.ibb.co/hMG0Nfy/broccoli.png'}, name: 'Broccoli', price: '10.00', gram: '250 g', quantity: 1 },
        { id: 8, image:{uri: 'https://i.ibb.co/R0Pgpx2/carrot.png'}, name: 'Carrot', price: '15.00', gram: '250 g', quantity: 1 },
        { id: 9, image:{uri: 'https://i.ibb.co/RHLGVbM/cucumber.png'}, name: 'Cucumber', price: '12.00', gram: '250 g', quantity: 1 },
        { id: 10, image:{ uri: 'https://i.ibb.co/dmykmBL/brinjal.webp' }, name: 'Brinjal', price: '15.00', gram: '250 g', quantity: 1 },
        { id: 11, image:{uri: 'https://i.ibb.co/q5dpwyQ/corn.png'}, name: 'Corn', price: '20.00', gram: '250 g', quantity: 1 },
        { id: 12, image:{uri: 'https://i.ibb.co/bLYNhhr/capsicum.png'}, name: 'Capsicum', price: '15.00', gram: '250 g', quantity: 1 },
    ]);
