...
const CategorySpinach = () => {
    ...
    const [trendingDeals, setTrendingDeals] = useState([
        { id: 19, image:{uri: 'https://i.ibb.co/f9NzV4N/sb.png'}, name: 'Sun Berry', price: '10.00', gram: '250 g', quantity: 1 },
        { id: 20, image:{uri: 'https://i.ibb.co/92LnghQ/dl.png'}, name: 'Drumstick Leaves', price: '15.00', gram: '250 g', quantity: 1 },
        { id: 21, image:{uri: 'https://i.ibb.co/8MYsTvk/sl.webp'}, name: 'Stem Lettuce', price: '12.00', gram: '250 g', quantity: 1 },
        { id: 22, image:{uri: 'https://i.ibb.co/cgp2545/curry.png'}, name: 'Curry Leaves', price: '15.00', gram: '250 g', quantity: 1 },
        { id: 23, image:{uri: 'https://i.ibb.co/Y3r3pyx/mint.png'}, name: 'Spear Mint', price: '20.00', gram: '250 g', quantity: 1 },
        { id: 24, image:{uri: 'https://i.ibb.co/wNSsShY/coriander.webp'}, name: 'Coriander Leaves', price: '15.00', gram: '250 g', quantity: 1 },
    ]);
...
export default CategorySpinach;
